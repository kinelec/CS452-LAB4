...
void display(SDL_Window* screen){
	...
	GLfloat light1d[] = {20.0f, 20.0f, 20.0f};
  	GLfloat light1c[] = {0.1f, 0.1f, 0.1f};
  	GLfloat light2d[] = {-20.0f, -20.0f, -20.0f};
	...
	glUniform3fv(lightLocation,1,light2d);
	...
	glUniform3fv(lightLocation,1,light2c);
...
int main(int argc, char **argv){
	...
	window = SDL_CreateWindow("Kinel Lab 4",SDL_WINDOWPOS_UNDEFINED,SDL_WINDOWPOS_UNDEFINED,500,500,SDL_WINDOW_OPENGL);
